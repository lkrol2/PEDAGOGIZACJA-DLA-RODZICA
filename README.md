...
### 1.Forma współpracy szkoły ze środowiskiem rodzinnym.###
  ...
  3. Ważnym celem współpracy jest możliwie najlepsze poznanie przez nauczycieli poszczególnych uczniów ( ich sytuacji rodzinnej, bytowej, oczekiwań rodziców funkcjonowania w środowisku pozaszkolnym, zainteresowań i potrzeb).
